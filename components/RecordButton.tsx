    ...
    return (
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="text-blue-400 text-base font-semibold">Waiting for screen selection...</p>
          <p className="text-zinc-500 text-sm mt-1">Choose a screen or window to share</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      >
        ...
        {/* Button body */}
        <div
          className="relative w-full h-full rounded-full bg-gradient-to-br from-red-500 to-red-600 
